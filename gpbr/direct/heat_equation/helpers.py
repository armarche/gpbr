...
from ..common.collocation import collocation_points_2d

from ..common.distance import point_distance

from ..common.source import SourcePoints2D, SourcePoints3D, source_points_2d
from .polynomial import MFSPolinomials2D, MFSPolinomials3D, calculate_2d_polinomials

from ..common.boundary import Point2D, Point3D, StarlikeCurve, starlike_circle_base, starlike_curve
from .common import MFSConfig, MFSData
from .fundamental_sequence import FundamentalSequence, FundamentalSequenceCoefs, dfs_2d, fs_2d, fs_3d
import numpy as np
...
# def form_mfs_data(T: float, N: int, M: int) -> MFSData:
#     """
#     Form the common data for the method of fundamental solutions
#     """
