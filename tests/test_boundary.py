...
class TestBoundary(unittest.TestCase):
    ...
    def test_starlike_curve(self):
        ...
        normals = curve_with_normals.normals_np
        expected_normals = np.array([np.cos(collocation.theta), np.sin(collocation.theta)])
        np.testing.assert_almost_equal(normals, expected_normals)
    ...
    def test_starlike_surface(self):
        ...
        np.testing.assert_almost_equal(z, np.cos(theta_grid))
        ...
        np.testing.assert_almost_equal(surface_with_normals.normals_mesh_np, expected_normals)
